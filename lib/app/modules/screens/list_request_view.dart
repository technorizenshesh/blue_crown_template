...
import 'package:blue_crown_template/app/modules/controller/list_request_controller.dart';
...
class ListRequestView extends StatefulWidget {
  const ListRequestView({Key? key}) : super(key: key);
  @override
  State<ListRequestView> createState() => _ListRequestViewState();
}

class _ListRequestViewState extends State<ListRequestView> {
  ListRequestController controller = Get.put(ListRequestController());
  @override
