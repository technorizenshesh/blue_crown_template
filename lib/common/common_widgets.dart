...
class CommonWidgets {
  static appBar(
      {String? title, bool wantBackButton = true, List<Widget>? actions}) {
    return AppBar(
      elevation: 0,
      ...
      leading: wantBackButton
          ...
          : null,
      centerTitle: true,
      title: Text(title ?? '', style: MyTextStyle.titleStyle20bw),
      actions: actions,
    );
  }
  ...
  static Widget commonTextFieldForLoginSignUP(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(borderRadius ?? 14.px),
          border: Border.all(
              color: isCard ? primaryColor : primary3Color, width: 1.px)),
      child: Row(
        children: [
          prefixIcon != null
              ? Row(children: [
